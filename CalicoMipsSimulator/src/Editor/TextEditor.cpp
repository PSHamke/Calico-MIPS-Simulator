...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::CPlusPlus()
{
	...
	if (!inited)
	{
		...
		static const char* const identifiers[] = {
			...
			"ispunct", "isspace", "isupper", "kbhit", "log10", "log2", "log", "memcmp", "modf", "pow", "add", "sub", "mult", "putchar", "putenv", "puts", "rand", "remove", "rename", "sinh", "sqrt", "srand", "strcat", "strcmp", "strerror", "time", "tolower", "toupper",
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Lua()
{
	...
	{
		static const char* const keywords[] = {
			"$t0", "$t1", "t0", "", "else", "elseif", "end", "false", "for", "function", "if", "in", "", "local", "nil", "not", "or", "repeat", "return", "then", "true", "until", "while"
		};
		...
		static const char* const identifiers[] = {
			"data", "collectgarbage", "dofile", "error", "getmetatable", "ipairs", "loadfile", "load", "loadstring",  "next",  "pairs",  "pcall",  "add",  "sub",  "mult",  "rawget",  "rawset",
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::MIPS()
{
	...
	{
		static const char* const keywords[] = {
			"$t0", "$t1", "$t2", "$t3", "$t4", "$t5", "$t6", "$t7", "$t8", "function", "if", "in", "", "local", "nil", "not", "or", "repeat", "return", "then", "true", "until", "while"
		};
		...
		langDef.mTokenRegexStrings.push_back(std::make_pair<std::string, PaletteIndex>("[\\[\\]\\{\\}\\!\\%\\^\\&\\*\\(\\)\\-\\+\\=\\~\\|\\<\\>\\?\\/\\;\\,\\.]", PaletteIndex::Punctuation));
		langDef.mTokenRegexStrings.push_back(std::make_pair<std::string, PaletteIndex>("\\$t[0-8]", PaletteIndex::Register));
