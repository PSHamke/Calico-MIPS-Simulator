...
void ImDrawer::IDraw()
{
	...
	const ImColor col = ImColor(0.0f,0.1f,0.2f);
	...
	//AddHalfEllipse(m_DrawList, p + ImVec2(335.0f * 0.45f, 905.26f * 0.45f), 25 * m_Scale, 25 * m_Scale, 4.7f, IM_COL32(0xff, 0xff, 0xff, 0xff), 64, 1.0);
...
void ImDrawer::Init()
{
	...
	PathShapes noblePath(std::string ("NoblePath"));
	...
	//pathRects.push_back({ std::string("Canvas"), ImVec2(10 * scale, +20 * scale), ImVec2(+1300 * scale, +800 * scale), color, 0.0f, ImDrawFlags_None, 1.0 });
	{
		...
		pathRects.push_back({ PRect("InstructionMem",scale,170.f,450.f,270.f,590.f,color,rounding,ImDrawFlags_None,thickness) });
		pathRects.push_back({ PRect("RegisterFile",scale,500.f,420.f,650.f,620.f,color,rounding,ImDrawFlags_None,thickness) });
	...
	
	{
		...
		pathTriangles.push_back({ PSTriangle("MUX20Tri1",440.1f,514.5f,10.f,scale,color,thickness) });
	...
	// PathPolyLines
	{
		...
		std::vector<ImVec2> pcToMux8;
		pcToMux8.emplace_back(PPoint(60.25f, 460.f, scale));
		pcToMux8.emplace_back(PPoint(30.f, 460.f, scale));
		pcToMux8.emplace_back(PPoint(30.f, 40.f, scale));
		pcToMux8.emplace_back(PPoint(1171.15f, 45.15f, scale));
		pcToMux8.emplace_back(PPoint(1171.15f, 230.f, scale));
		pcToMux8.emplace_back(PPoint(1145.15f, 230.f, scale));

		pathPolyLines.push_back({ PPolyLines(("PcToMux8"),pcToMux8,(int)pcToMux8.size(),color,ImDrawFlags_None,thickness) });
		...
		mux5ToWriteData.emplace_back(PPoint(1270.65f, 530.0f, scale));
		mux5ToWriteData.emplace_back(PPoint(1270.65f, 770.0f, scale));
		...
		std::vector<ImVec2> node15ToMux8Tri1;
		node15ToMux8Tri1.emplace_back(PPoint(720.0f, 462.0f, scale));
		node15ToMux8Tri1.emplace_back(PPoint(720.25f, 420.0f, scale));
		node15ToMux8Tri1.emplace_back(PPoint(1100.25f, 420.0f, scale));
		node15ToMux8Tri1.emplace_back(PPoint(1100.25f, 250.0f, scale));
		node15ToMux8Tri1.emplace_back(PPoint(1110.25f, 250.0f, scale));
		pathPolyLines.push_back({ PPolyLines(("Node15ToMux8Tri1"),node15ToMux8Tri1,(int)node15ToMux8Tri1.size(),color,ImDrawFlags_None,thickness) });
		...
		std::vector<ImVec2> mux3ToAlu2Tri1;
		mux3ToAlu2Tri1.emplace_back(PPoint(755.25f, 548.0f, scale));
		mux3ToAlu2Tri1.emplace_back(PPoint(770.25f, 548.0f, scale));
		pathPolyLines.push_back({ PPolyLines(("Mux3ToAlu2Tri1"),mux3ToAlu2Tri1,(int)mux3ToAlu2Tri1.size(),color,ImDrawFlags_None,thickness) });
		...
		std::vector<ImVec2> sl2ToAlu3Tri1;
		sl2ToAlu3Tri1.emplace_back(PPoint(735.0f, 258.0f, scale));
		sl2ToAlu3Tri1.emplace_back(PPoint(771.25f, 258.0f, scale));
		pathPolyLines.push_back({ PPolyLines(("SL2ToAlu3Tri1"),sl2ToAlu3Tri1,(int)sl2ToAlu3Tri1.size(),color,ImDrawFlags_None,thickness) });
	...
	noblePath.SetPathRects(pathRects);
	noblePath.SetPathEllipses(pathEllipses);
	noblePath.SetPathPolyLines(pathPolyLines);
	noblePath.SetPathTriangles(pathTriangles);
	noblePath.SetPathCircles(pathCircles);
	noblePath.SetPathTexts(pathTexts);
	m_ShapesVec.push_back(noblePath);
}
